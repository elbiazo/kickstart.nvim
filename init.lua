...
vim.g.have_nerd_font = false -- ELB: Using nerd font. Enable it
...
require('lazy').setup({
  ...
  -- ELB: adding tabby so that tab shows line number
  {
    'nanozuki/tabby.nvim',
    event = 'VimEnter',
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        -- ELB: Added clangd option. Do need to set offsetEncoding to utf-16 but not sure about others.
        -- ELB: Got it from https://www.lazyvim.org/extras/lang/clangd#nvim-lspconfig
        clangd = {
          keys = {
  ...
  -- ELB: Changing colorscheme to onedarkpro from tokyonight
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = {
      signs = false,
      -- ELB: adding keywords for ELB
      keywords = {
        ELB = { icon = '', color = 'info' },
      },
      -- ELB: end of adding keywords for ELB
    },
  },
